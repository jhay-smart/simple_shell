...
/**
* cd_dots - this changes to the parent directory
*
* @datash: This represents the relevant data (environ)
*
* Return: no return
*/
...
/**
* cd_to - This will change to the directory given
* by the user
*
* @datash: This is a data that is relevant (directories)
* Return: return 0
*/
